      ...
      >
        <div
          ...
          className={cn(
            ...
            variant === "inset" && "rounded-xl border border-sidebar-border shadow"
          )}
        >
          {children}
        </div>
